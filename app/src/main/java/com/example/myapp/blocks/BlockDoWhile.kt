...
@Composable
fun drawDoWhileBlock(block: Block, blocksList: MutableList<Block>, shiftBlock: Boolean) {
    ...
    var lastId = 0
    val blockType = block.blockType as DoWhileBlock
    ...
    Box(contentAlignment = Alignment.CenterStart) {
        ...
        ) { Text("do while", color = Color.White, textAlign = TextAlign.Center) }
